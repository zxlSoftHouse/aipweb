  ...
  <el-row class="app-container userManage">
    <el-col>
        <el-row>
          ...
          <el-col :span="6">
            <el-input type="text" placeholder="请输入系统账号或用户名" v-model="userName"></el-input>
          </el-col>
          <el-col :span="2">
        ...
        <el-table ref="multipleTable" :data="tableList" 
          ...
          style="width: 100%" @selection-change="handleSelectionChange" >
            <el-table-column property="userCode" label="系统账号">
            </el-table-column>
          ...
          @close="cannelUpdate('ruleForm')">
            ...
            <el-dialog
              ...
              :append-to-body="true">
              <el-form :model="modifyPwd" :inline="true" :rules="modifyPwdRules" ref="modifyPwdForm" label-width="130px">
            ...
            <el-form :model="user" :rules="rules" :inline="true" ref="ruleForm" label-width="130px">
              <el-form-item label="系统账号" prop="userCode">
                <el-input size="medium" v-bind:disabled="this.dialogTitle==='修改'" v-model="user.userCode" auto-complete="off" placeholder=""></el-input>
              </el-form-item>
              <el-form-item v-if="dialogTitle==='新增'" label="系统密码" prop="password">
                <el-input size="medium" v-model="user.password" type="password" auto-complete="off" placeholder=""></el-input>
              </el-form-item>
              <el-form-item v-else-if="dialogTitle==='修改'" label="系统密码" prop="password">
